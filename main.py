                            ...
                            try:
                                ...
                                if _as_cfg.get("enabled", True):
                                    ...
                                    if _deliver:
                                        ...
                                        from src.inbox.autosend_helpers import autosend_voice as _autosend_voice_impl
                                        async def _try_autosend_voice(platform, account_id, chat_key, text) -> bool:
                                            return await _autosend_voice_impl(_assistant_ref, platform, account_id, chat_key, text)
                                        from src.inbox.autosend_helpers import autosend_image as _autosend_image_impl
                                        async def _try_autosend_image(platform, account_id, chat_key, text) -> bool:
                                            return await _autosend_image_impl(_assistant_ref, platform, account_id, chat_key, text)
