...
const zh: Dict = {
  ...
  solutionsSection: {
    title: "三大产品系 · 一个无界底座",
    subtitle: "智连获客（智拓拉新 + 智聊承接）、幻境分身（换脸/克隆/直播分身）、通达跨语（实时翻译 + 同声传译）——三系共享无界底座，私有部署、数据自主，按需单独选用或组合。",
  },
  solutions: [
    {
      id: "reach",
      tag: "智拓 ReachX",
      title: "私域流量获取",
      desc: "真机多号自动加好友、打招呼、按人设话术引流进私域；频控养号 + 拟人操作降低风控风险，从公域捞人到私域承接一条龙。",
      features: ["真机多号并发", "自动加友 + 打招呼", "人设话术引流", "频控养号防风控"],
      pricing: [
        { plan: "起步", price: "198 / 月", detail: "5 养号设备，自动加友 + 打招呼" },
        { plan: "增长", price: "598 / 月", detail: "20 设备，全链路获客 + 引流" },
        { plan: "私有化部署", price: "3000 起", detail: "真机集群方案，按规模报价" },
      ],
    },
    {
      id: "voice",
    ...
    },
    {
      ...
      desc: "影视级图片 / 视频换脸：inswapper + GFPGAN / CodeFormer 精修 + 光流时序平滑，三路并发批量出片；开播前还能 AI 定妆换发型。实时换脸见上方旗舰服务。",
      features: ["图片 / 视频换脸", "GFPGAN / CodeFormer 精修", "双人 face_map", "开播前 AI 定妆"],
      pricing: [
    ...
    },
    {
      ...
      tag: "通译 LingoX",
      title: "实时聊天翻译 SCRM",
      desc: "多平台收发消息实时双向翻译：术语锁定专有名词、翻译记忆省成本；统一收件箱多坐席协作、客户资产自动沉淀——不只是翻译，更是跨境私域客服中台。",
      features: ["实时双向翻译", "术语锁定 + 品牌保护", "翻译记忆省成本", "多坐席 + 客户资产"],
      highlight: true,
      pricing: [
        { plan: "字符包", price: "38 / 150万字符", detail: "多平台双向翻译 + 术语锁定" },
        { plan: "团队", price: "58 / 月起", detail: "多坐席收件箱 + 客户资产沉淀" },
        { plan: "专业", price: "128 / 月", detail: "不限字符 + 多模态翻译 + 翻译记忆" },
    ...
    },
    {
      ...
      pricing: [
        { plan: "按量", price: "0.5 / 分钟", detail: "克隆音实时口译，会议 / 直播" },
        { plan: "包月", price: "198 / 月", detail: "OBS 双语字幕 + 抢话打断" },
        { plan: "私有化部署", price: "3000 起", detail: "买断 + 600 / 年维护" },
      ],
    },
    {
    ...
    },
    {
      ...
      tag: "幻影 LiveX",
      title: "高清活体数字人 / 虚拟主播",
      desc: "克隆形象 + 克隆声 + 口型同步的活体分身，会眨眼、会摆头、有微表情——不是死图对口型。一路直推 WebRTC / OBS，5090 上 25fps 高清、亚秒级首帧。",
...
const en: Dict = {
  ...
  solutionsSection: {
    title: "Three Product Families · One Boundless Core",
    subtitle: "Growth (ReachX acquisition + ChatX desk), Studio (face swap / voice clone / live avatar), Lingo (LingoX chat translation + VoxX interpreting) — three families on one BOUNDLESS core, privately deployed and composable on demand.",
  },
  solutions: [
    {
      id: "reach",
      tag: "ReachX",
      title: "Private-traffic Acquisition",
      desc: "Multi-device auto add-friend, greet and persona-scripted funnel-in to private channels; rate-limited nurturing + human-like actions cut ban risk — from public pools to private engagement, end to end.",
      features: ["Multi-device concurrency", "Auto add + greet", "Persona-scripted funnel", "Rate-limit nurturing"],
      pricing: [
        { plan: "Starter", price: "198 / mo", detail: "5 nurture devices, auto add + greet" },
        { plan: "Growth", price: "598 / mo", detail: "20 devices, full-funnel acquisition" },
        { plan: "Self-hosted", price: "from 3000", detail: "Device-cluster, quote by scale" },
      ],
    },
    {
      id: "voice",
    ...
    },
    {
      ...
      tag: "FaceX",
      title: "AI Face Swap",
      desc: "Cinematic image / video swaps: inswapper + GFPGAN / CodeFormer refinement + optical-flow smoothing, batched 3-way; plus pre-broadcast AI hairstyle & makeup. Real-time swap is the flagship above.",
      features: ["Image / video swap", "GFPGAN / CodeFormer refine", "Dual-person face_map", "Pre-broadcast makeup"],
      pricing: [
    ...
    },
    {
      id: "translate",
      tag: "LingoX",
      title: "Real-time Chat Translation SCRM",
      desc: "Real-time two-way translation across messaging platforms: glossary locks proper nouns, translation memory cuts cost; a unified multi-agent inbox with customer assets accruing automatically — not just translation, but a cross-border private CRM desk.",
      features: ["Real-time two-way translation", "Glossary + brand protection", "Translation memory saves cost", "Multi-agent + customer assets"],
      highlight: true,
      pricing: [
        { plan: "Char pack", price: "38 / 1.5M chars", detail: "Cross-platform translation + glossary" },
        { plan: "Team", price: "from 58 / mo", detail: "Multi-agent inbox + customer assets" },
        { plan: "Pro", price: "128 / mo", detail: "Unlimited chars + multimodal + memory" },
    ...
    },
    {
      id: "interpret",
      tag: "VoxX",
      title: "Simultaneous Interpreting + Subtitles",
      ...
      pricing: [
        { plan: "Usage", price: "0.5 / min", detail: "Cloned-voice interpreting, meetings / live" },
        { plan: "Monthly", price: "198 / mo", detail: "OBS bilingual subtitles + barge-in" },
        { plan: "Self-hosted", price: "from 3000", detail: "Buyout + 600 / yr support" },
      ],
    },
    {
    ...
    },
    {
      ...
      desc: "A living twin — cloned face + cloned voice + lip-sync that blinks, turns its head and emotes, not a still photo. Streamed straight to WebRTC / OBS at 25fps HD with a sub-second first frame on a 5090.",
